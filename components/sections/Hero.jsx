      ...
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div ref={leftContentRef} className="flex flex-col items-start gap-6 z-10">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-2">
            ...
            <a
              href="https://drive.google.com/file/d/1jYXo3NJ-OlL3P_TfM9JG7429kvufltdG/view?usp=sharing"
              target="_blank"
          ...
          <div className="flex items-center gap-5 mt-4">
            <a href="https://github.com/golamsarwar96" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full glass hover:bg-white/10 hover:text-accent-primary hover:-translate-y-1 transition-all">
              <FaGithub className="w-5 h-5" />
            </a>
            <a href="https://bd.linkedin.com/in/md-golamsarwar" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full glass hover:bg-white/10 hover:text-accent-primary hover:-translate-y-1 transition-all">
              <FaLinkedin className="w-5 h-5" />
            </a>
            <a href="mailto:sarwartasin1896@gmail.com" className="p-3 rounded-full glass hover:bg-white/10 hover:text-accent-primary hover:-translate-y-1 transition-all">
